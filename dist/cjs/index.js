...
const ReactReportsViewer = ({ handleSubmit, imageReportPathname, initialValues, isLoading, rCCodeList, reportNameList, reportTypeList, setInitialValues }) => {
    const [form] = antd.Form.useForm();
    const displayReportNameDropdownList = (list) => {
        return (React.createElement(antd.Form.Item, { label: 'Report Name :', name: 'reportName' },
            React.createElement(antd.Select, { options: list.map((item) => ({
                    value: item.value,
                    label: item.value
                })), onChange: (_value) => {
    ...
    const displayRCCodeDropdownList = (list) => {
        return (React.createElement(antd.Form.Item, { label: 'RC Code :', name: 'rCCode' },
            React.createElement(antd.Select, { options: list.map((item) => ({
                    value: item.value,
                    label: item.value
                })), onChange: (_value) => {
    ...
    const displayReportTypeDropdownList = (list) => {
        return (React.createElement(antd.Form.Item, { label: 'Report Type :', name: 'reportType' },
            React.createElement(antd.Select, { options: list.map((item) => ({
    ...
    const displayReportDate = () => {
        return (React.createElement(antd.Form.Item, { label: 'Date :', name: 'date' },
            React.createElement(antd.DatePicker, { onChange: (_date, dateString) => {
                    const fieldsValue = form.getFieldsValue();
                    setInitialValues(Object.assign(Object.assign({}, fieldsValue), { date: dateString }));
                } })));
    };
    imageReportPathname && console.log(getDataUrl(imageReportPathname), 'getDataUrl(imageReportPathname)');
    return (React.createElement(React.Fragment, null,
        React.createElement(antd.Row, null,
            React.createElement("h1", null, "Reports Viewer")),
        React.createElement(antd.Row, null,
            React.createElement(antd.Col, { span: 8, className: 'test' }, isLoading ? (React.createElement(antd.Skeleton, null)) : (React.createElement("section", { className: 'code-box' },
                React.createElement(antd.Form, { form: form, initialValues: initialValues, labelCol: { span: 8 }, wrapperCol: { span: 16 } },
                    reportTypeList
                    ...
                    displayReportDate(),
                    React.createElement(antd.Form.Item, { wrapperCol: { offset: 8, span: 16 } },
                        React.createElement(antd.Button, { type: 'primary', htmlType: 'submit', onClick: () => {
                                handleSubmit && handleSubmit();
                            }, disabled: (reportNameList === null || reportNameList === void 0 ? void 0 : reportNameList.length) === 0 &&
                                initialValues.reportType === '' }, "Submit")))))),
            React.createElement(antd.Col, { span: 16 },
                imageReportPathname ? (React.createElement("iframe", { title: 'Reports View', src: `${getDataUrl(imageReportPathname)}#toolbar=0&view=fitH`, height: '600px', width: '100%' })) : (React.createElement(antd.Empty, { image: 'https://gw.alipayobjects.com/zos/antfincdn/ZHrcdLPrvN/empty.svg', imageStyle: { height: 400 } })),
                React.createElement(antd.Row, null,
                    React.createElement(antd.Col, { span: 24 },
                        React.createElement("div", { className: 'space-align-container' },
                            React.createElement(antd.Space, { align: 'end' },
                                React.createElement(antd.Button, { type: 'primary' }, "Cancel"),
                                React.createElement(antd.Button, { type: 'primary' }, "Print")))))))));
};
