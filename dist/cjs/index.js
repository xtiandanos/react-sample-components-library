...
const Button$2 = (props) => {
    return React$2.createElement("button", null, props.label);
};
...
function warningOnce$1(valid, message) {
  call$1(warning$4, valid, message);
}
...
var Context$2 = /*#__PURE__*/react.exports.createContext({
...
function convertMessages(messages, name, rule, messageVariables) {
  var kv = _objectSpread2$4(_objectSpread2$4({}, rule), {}, {
    name: name,
    enum: (rule.enum || []).join(', ')
  });
  ...
  var replaceFunc = function replaceFunc(template, additionalKV) {
    return function () {
      return replaceMessage(template, _objectSpread2$4(_objectSpread2$4({}, kv), additionalKV));
    };
  };
    ...
    return regenerator.wrap(function _callee2$(_context2) {
      while (1) {
        switch (_context2.prev = _context2.next) {
          case 0:
            cloneRule = _objectSpread2$4({}, rule); // We should special handle array validate
            ...
            _context2.prev = 7;
            _context2.next = 10;
            return Promise.resolve(validator.validate(_defineProperty({}, name, value), _objectSpread2$4({}, options)));
            ...
            if (_context2.t0.errors) {
              result = _context2.t0.errors.map(function (_ref2, index) {
                ...
                return (// Wrap ReactNode with `key`
                  ...
                  /*#__PURE__*/
                  react.exports.isValidElement(message) ? /*#__PURE__*/react.exports.cloneElement(message, {
...
function validateRules(namePath, value, rules, options, validateFirst, messageVariables) {
  ...
  var filledRules = rules.map(function (currentRule) {
    ...
    return _objectSpread2$4(_objectSpread2$4({}, currentRule), {}, {
...
function WrapperField(_ref4) {
  ...
  var fieldContext = react.exports.useContext(Context$2);
  ...
  if (process.env.NODE_ENV !== 'production') {
    warningOnce$1(restProps.preserve !== false || !restProps.isListField, '`preserve` should not apply on Form.List fields.');
  }

  return /*#__PURE__*/react.exports.createElement(Field, Object.assign({
    key: key,
    name: namePath
  }, restProps, {
...
var List = function List(_ref) {
  ...
  var context = react.exports.useContext(Context$2);
  ...
  return /*#__PURE__*/react.exports.createElement(Context$2.Provider, {
  ...
  return /*#__PURE__*/react.exports.createElement(FormContext.Provider, {
    value: _objectSpread2$4(_objectSpread2$4({}, formContext), {}, {
      ...
      registerForm: function registerForm(name, form) {
        if (name) {
          formsRef.current = _objectSpread2$4(_objectSpread2$4({}, formsRef.current), {}, _defineProperty({}, name, form));
        }
...
var Form = function Form(_ref, ref) {
  ...
  var wrapperNode = /*#__PURE__*/react.exports.createElement(Context$2.Provider, {
  ...
  return /*#__PURE__*/react.exports.createElement(Component, Object.assign({}, restProps, {
...
var Empty = function Empty(_a) {
  ...
  return /*#__PURE__*/react.exports.createElement(LocaleReceiver, {
    ...
    return /*#__PURE__*/react.exports.createElement("div", _extends$1({
      ...
      style: imageStyle
    }, imageNode), des && /*#__PURE__*/react.exports.createElement("p", {
...
var useIsomorphicLayoutEffect = canUseDom$2() ? react.exports.useLayoutEffect : react.exports.useEffect;

var raf$3 = function raf(callback) {
...
var LoadingOutlined$5 = {exports: {}};

var LoadingOutlined$4 = {};
...
LoadingOutlined$3.default = LoadingOutlined$2;
...
var _default$4 = IconContext;
Context.default = _default$4;
...
warning$2.preMessage = preMessage;
...
var _react = _interopRequireWildcard$2(react.exports);
...
function generate(node, key, rootProps) {
  if (!rootProps) {
    return /*#__PURE__*/_react.default.createElement(node.tag, (0, _objectSpread2$3.default)({
      key: key
    }, normalizeAttrs(node.attrs)), (node.children || []).map(function (child, index) {
      return generate(child, "".concat(key, "-").concat(node.tag, "-").concat(index));
    }));
  }
  return /*#__PURE__*/_react.default.createElement(node.tag, (0, _objectSpread2$3.default)((0, _objectSpread2$3.default)({
    key: key
...
var useInsertStyles = function useInsertStyles() {
  ...
  var _useContext = (0, _react.useContext)(_Context$1.default),
    csp = _useContext.csp;
...
var _objectWithoutProperties2$1 = _interopRequireDefault$3(objectWithoutProperties.exports);
var _objectSpread2$2 = _interopRequireDefault$3(objectSpread2.exports);
var _utils$2 = utils;
...
var IconBase = function IconBase(props) {
  var icon = props.icon,
    ...
    restProps = (0, _objectWithoutProperties2$1.default)(props, _excluded$1);
  ...
  return (0, _utils$2.generate)(target.icon, "svg-".concat(target.name), (0, _objectSpread2$2.default)({
    className: className,
    onClick: onClick,
    style: style,
...
var _default$2 = IconBase;
IconBase$1.default = _default$2;
...
var _classnames = _interopRequireDefault$1(classnames.exports);
...
var Icon = /*#__PURE__*/React$1.forwardRef(function (props, ref) {
  ...
  var _normalizeTwoToneColo = (0, _utils.normalizeTwoToneColors)(twoToneColor),
    ...
    primaryColor = _normalizeTwoToneColo2[0],
    secondaryColor = _normalizeTwoToneColo2[1];
  return /*#__PURE__*/React$1.createElement("span", (0, _objectSpread2$1.default)((0, _objectSpread2$1.default)({
    role: "img",
...
var _default$1 = Icon;
AntdIcon.default = _default$1;

var _interopRequireDefault = interopRequireDefault.exports;
var _typeof = _typeof$2.exports;
Object.defineProperty(LoadingOutlined$4, "__esModule", {
  value: true
});
LoadingOutlined$4.default = void 0;
var _objectSpread2 = _interopRequireDefault(objectSpread2.exports);
var React = _interopRequireWildcard(react.exports);
var _LoadingOutlined = _interopRequireDefault(LoadingOutlined$3);
...
var LoadingOutlined$1 = function LoadingOutlined(props, ref) {
...
var _default = /*#__PURE__*/React.forwardRef(LoadingOutlined$1);
LoadingOutlined$4.default = _default;
...
(function (module, exports) {
  ...
  var _LoadingOutlined = _interopRequireDefault(LoadingOutlined$4);
...
}(LoadingOutlined$5, LoadingOutlined$5.exports));

var LoadingOutlined = /*@__PURE__*/getDefaultExportFromCjs(LoadingOutlined$5.exports);
...
function replaceElement(element, replacement, props) {
  ...
  return /*#__PURE__*/react.exports.cloneElement(element, typeof props === 'function' ? props() : props);
}
...
var ButtonGroup = function ButtonGroup(props) {
  return /*#__PURE__*/react.exports.createElement(ConfigConsumer, null, function (_ref) {
    ...
    return /*#__PURE__*/react.exports.createElement("div", _extends$1({}, others, {
      className: classes
    }));
  });
};
...
function wrapperRaf(callback) {
  ...
  function internalCallback() {
    ...
    if (restFrames <= 0) {
      ...
      ids[myId] = raf$1(internalCallback);
    }
  }
...
var LoadingIcon = function LoadingIcon(_ref) {
  ...
  if (existIcon) {
    ...
    }, /*#__PURE__*/react.exports.createElement(LoadingOutlined, null));
  }
  ...
  return /*#__PURE__*/react.exports.createElement(CSSMotion, {
    ...
    return /*#__PURE__*/react.exports.createElement("span", {
      ...
      style: style,
      ref: ref
    }, /*#__PURE__*/react.exports.createElement(LoadingOutlined, {
...
var InternalButton = function InternalButton(props, ref) {
  ...
  var delayTimeoutRef = react.exports.useRef();
  ...
  if (_typeof$3(loading) === 'object' && loading.delay) {
  ...
  var buttonNode = /*#__PURE__*/react.exports.createElement("button", _extends$1({}, omit(otherProps, ['loading']), {
    type: htmlType,
    className: classes,
    onClick: handleClick,
    ref: buttonRef
  ...
  return /*#__PURE__*/react.exports.createElement(Wave, null, buttonNode);
};
...
const ReactReportsViewer = ({}) => {
    ...
    return (React$2.createElement(React$2.Fragment, null,
        React$2.createElement(Button$1, null, "here")));
};

exports.Button = Button$2;
exports.ReactReportsViewer = ReactReportsViewer;
