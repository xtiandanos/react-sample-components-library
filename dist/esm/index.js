import { Form, Row, Col, Skeleton, Button as Button$1, Empty, Space, Select, DatePicker } from 'antd';
...
const ReactReportsViewer = ({ handleSubmit, imageReportPathname, initialValues, isLoading, rCCodeList, reportNameList, reportTypeList, setInitialValues }) => {
    ...
    const displayReportNameDropdownList = (list) => {
        return (React.createElement(Form.Item, { label: 'Report Name :', name: 'reportName' },
            React.createElement(Select, { options: list.map((item) => ({
                    value: item.value,
                    label: item.value
                })), onChange: (_value) => {
    ...
    const displayRCCodeDropdownList = (list) => {
        return (React.createElement(Form.Item, { label: 'RC Code :', name: 'rCCode' },
            React.createElement(Select, { options: list.map((item) => ({
                    value: item.value,
                    label: item.value
                })), onChange: (_value) => {
    ...
    const displayReportTypeDropdownList = (list) => {
        return (React.createElement(Form.Item, { label: 'Report Type :', name: 'reportType' },
            React.createElement(Select, { options: list.map((item) => ({
    ...
    const displayReportDate = () => {
        return (React.createElement(Form.Item, { label: 'Date :', name: 'date' },
            React.createElement(DatePicker, { onChange: (_date, dateString) => {
    ...
    return (React.createElement(React.Fragment, null,
        ...
        React.createElement(Row, null,
            React.createElement(Col, { span: 8, className: 'test' }, isLoading ? (React.createElement(Skeleton, null)) : (React.createElement("section", { className: 'code-box' },
                React.createElement(Form, { form: form, initialValues: initialValues, labelCol: { span: 8 }, wrapperCol: { span: 16 } },
                    reportTypeList
                    ...
                    React.createElement(Form.Item, { wrapperCol: { offset: 8, span: 16 } },
                        React.createElement(Button$1, { type: 'primary', htmlType: 'submit', onClick: () => {
            ...
            React.createElement(Col, { span: 16 },
                imageReportPathname ? (React.createElement("iframe", { title: 'Reports View', src: `${getDataUrl(imageReportPathname)}#toolbar=0&view=fitH`, height: '600px', width: '100%' })) : (React.createElement(Empty, { image: 'https://gw.alipayobjects.com/zos/antfincdn/ZHrcdLPrvN/empty.svg', imageStyle: { height: 400 } })),
                React.createElement(Row, null,
                    React.createElement(Col, { span: 24 },
                        React.createElement("div", { className: 'space-align-container' },
                            React.createElement(Space, { align: 'end' },
                                React.createElement(Button$1, { type: 'primary' }, "Cancel"),
                                React.createElement(Button$1, { type: 'primary' }, "Print")))))))));
};
